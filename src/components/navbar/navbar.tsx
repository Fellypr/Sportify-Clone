      ...
      <div className="flex items-center justify-between space-x-4  h-[4rem] pl-2">
        <div className="flex items-center space-x-4 p-4 w-full">
          ...
          <div className="flex items-center justify-center">
            <IoIosSearch size={32} color="white" className="absolute left-[9rem]" />
            <input
              type="text"
              className="pl-12 bg-zinc-800 text-white rounded-full px-4 py-2 w-120 h-12 focus:outline-none focus:ring-2 focus:ring-white-500"
